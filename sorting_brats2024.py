...
BRATS_TRAIN_DIRECTORY = '../../data/ped-brats2024/train/'
BRATS_TEST_DIRECTORY = '../../data/ped-brats2024/val/'
NNUNET_DIRECTORY = '../../data/nnunet-environment/nnUNet_raw/Dataset002_BrainTumourBrats2024/'
...
for idx, train_folder in enumerate(train_folders):
    # Get the images
    if os.path.isdir(BRATS_TRAIN_DIRECTORY + train_folder):
...
for idx, test_folder in enumerate(test_folders):
    # Get the images
    if os.path.isdir(BRATS_TEST_DIRECTORY + test_folder):
