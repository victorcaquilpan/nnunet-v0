...
if __name__ == '__main__':
    ...
    folder_ref = '/data/nnunet-environment/nnUNet_raw/Dataset004_BrainTissueRaw1000/labelsTs/'
    folder_pred = '/data/nnunet-environment/nnUNet_results/Dataset004_BrainTissueRaw1000/nnUNetTrainer__nnUNetPlans__3d_fullres/predictions/'
    output_file = '/data/nnunet-environment/nnUNet_results/Dataset004_BrainTissueRaw1000/nnUNetTrainer__nnUNetPlans__3d_fullres/summary_pred.json'
